            ...
            <ul class="slides photogrid">
              ...
              <li>
                <a class="featured-header" href="<?php the_permalink(); ?>">
                  <div class="ellipsis"><h3 class="listing-header"><?php if ( mb_strlen( get_the_title() ) >= $cp_options->featured_trim ) echo mb_substr( ucwords(strtolower(get_the_title())), 0, $cp_options->featured_trim ).'...'; else { echo ucwords(strtolower( get_the_title() ) ) ; } ?></h3></div>
